...
st.set_page_config(page_title="Back to PortalRecruit", page_icon="↩️", layout="wide")
...
<div style="max-width:760px; margin: 8vh auto 0 auto; text-align:center;">
  <h1 style="font-size:44px; font-weight:900; margin-bottom:10px;">Returning to PortalRecruit</h1>
